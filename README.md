...
3. **Respaldos:** en **Inventario** (expander *Respaldo de inventario*) y en **Mantenimiento** (solo superusuario) podés descargar JSON con datos de Supabase. Guardalos fuera del repo; la restauración, si aplica, es manual.
